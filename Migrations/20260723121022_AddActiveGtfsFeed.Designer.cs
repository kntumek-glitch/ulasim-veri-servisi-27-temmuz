...
namespace ulasim_veri_servisi.Migrations
{
    ...
    [Migration("20260723121022_AddActiveGtfsFeed")]
    partial class AddActiveGtfsFeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransportDataService.Domain.GtfsImportRun", b =>
                {
                    ...
                    b.ToTable("GtfsImportRuns", t =>
                        {
                            t.HasCheckConstraint("CK_GtfsImportRuns_ActiveFeedMustBeCompleted", "NOT \"IsActive\" OR \"Status\" = 'Completed'");
                        });
                });
