...
public class StopSequenceTests : IAsyncLifetime
{
    ...
    {
        // Arrange - Seed data
        var route = new GtfsRoute { Id = 1, RouteId = "route_1", RouteShortName = "R1" };
        var trip = new GtfsTrip { Id = 1, TripId = "trip_1", RouteId = "route_1", DirectionId = 0, GtfsRouteId = 1 };
        
        var stop1 = new GtfsStop { Id = 1, StopId = "stop_1", StopName = "Stop 1" };
        var stop2 = new GtfsStop { Id = 2, StopId = "stop_2", StopName = "Stop 2" };
        var stop3 = new GtfsStop { Id = 3, StopId = "stop_3", StopName = "Stop 3" };

        // Add stop times OUT OF ORDER
        var st3 = new GtfsStopTime { Id = 1, GtfsTripId = 1, GtfsStopId = 3, StopSequence = 30 };
        var st1 = new GtfsStopTime { Id = 2, GtfsTripId = 1, GtfsStopId = 1, StopSequence = 10 };
        var st2 = new GtfsStopTime { Id = 3, GtfsTripId = 1, GtfsStopId = 2, StopSequence = 20 };
